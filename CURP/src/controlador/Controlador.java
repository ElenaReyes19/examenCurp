...
public class Controlador {
    ...
    public void generarCURP(){
        ...
        switch(estado){
            case "AGUASCALIENTES":
                curp=curp.concat("AS"); break;
            case "BAJA CALIFORNIA":
                curp=curp.concat("BC"); break;
            case "BAJA CALIFORNIA SUR":
                curp=curp.concat("BS"); break;
            case "CAMPECHE":
                curp=curp.concat("CC"); break;
            case "CHIAPAS":
                curp=curp.concat("CS"); break;
            case "CHIHUAHUA":
                curp=curp.concat("CH"); break;
            case "COAHUILA":
                curp=curp.concat("CL"); break;
            case "COLIMA":
                curp=curp.concat("CM"); break;
            case "DF":
                curp=curp.concat("DF"); break;
            case "DURANGO":
                curp=curp.concat("DG"); break;
            case "GUANAJUATO":
                curp=curp.concat("GT"); break;
            case "GUERRERO":
                curp=curp.concat("GR"); break;
            case "HIDALGO":
                curp=curp.concat("HG"); break;
            case "JALISCO":
                curp=curp.concat("JC"); break;
            case "ESTADO DE MEXICO":
                curp=curp.concat("MC"); break;
            case "MICHOACAN":
                curp=curp.concat("MN"); break;
            case "MORELOS":
                curp=curp.concat("MS"); break;
            case "NAYARIT":
                curp=curp.concat("NT"); break;
            case "NUEVO LEON":
                curp=curp.concat("NL"); break;
            case "OAXACA":
                curp=curp.concat("OC"); break;
            case "PUEBLA":
                curp=curp.concat("PL"); break;
            case "QUERETARO":
                curp=curp.concat("QT"); break;
            case "QUINTANA ROO":
                curp=curp.concat("QR"); break;
            case "SAN LUIS POTOSI":
                curp=curp.concat("SP"); break;
            case "SINALOA":
                curp=curp.concat("SL"); break;
            case "SONORA":
                curp=curp.concat("SR"); break;
            case "TABASCO":
                curp=curp.concat("TC"); break;
            case "TAMAULIPAS":
                curp=curp.concat("TS"); break;
            case "TLAXCALA":
                curp=curp.concat("TL"); break;
            case "VERACRUZ":
                curp=curp.concat("VZ"); break;
            case "YUCATAN":
                curp=curp.concat("YN"); break;
            case "ZACATECAS":
                curp=curp.concat("ZS"); break;
            default:
                curp=curp.concat("NE"); break;
        }
